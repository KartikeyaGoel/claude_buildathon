...
export async function gradeSteelmanOutput(params) {
    ...
    }, { signal }), { signal, label: "grade steelman" });
...
export function sumSteelmanScores(grade) {
    return grade.scores.strength + grade.scores.specificity + grade.scores.novelty;
}
//# sourceMappingURL=SteelmanGrader.js.map